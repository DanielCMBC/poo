    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (genderInput.length() == 1 &&
                (genderInput.charAt(0) == 'M' || genderInput.charAt(0) == 'F')) {
        ...
        String genderString = (profile.getGender() == 'M' || profile.getGender() == 'm')
            ? "Masculino"
            : "Feminino";
        ...
        double[] targetHeartRateRange = profile.calculateTargetHeartRateRange();
        System.out.printf(
            "Faixa de frequência cardíaca alvo: %.0f - %.0f bpm%n",
            targetHeartRateRange[0],
            targetHeartRateRange[1]
        );
